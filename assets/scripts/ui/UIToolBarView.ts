...
export class UIToolBarView extends BaseUI {
    ...
    protected showView(params: any): void {
        ...
        // 👂 监听切枪事件
        EventManager.getInstance().on(SystemEvents.ToolChanged, this._onToolChanged, this);
    ...
    protected closeView(): void {
        ...
        EventManager.getInstance().off(SystemEvents.ToolChanged, this._onToolChanged, this);
        super.closeView();
    }
